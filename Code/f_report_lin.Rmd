...
#correlation test
cor.test(corynTot, age, method = "spearman")
cor.test(staphTot, age, method = "spearman")
...
# Appendix
1. plots for each species versus age
```{r echo = FALSE}
grid.arrange(pcor1, pcor2, pcor3, pcor4, nrow = 2)
grid.arrange(pstaph1, pstaph2, pstaph3, pstaph4, nrow = 2)
```
2. A look at difference of Spearman Rank correlation estimate significanes for different sample sizes
